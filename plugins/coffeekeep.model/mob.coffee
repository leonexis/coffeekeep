...
class Mob extends Model
  @gender:          # Appearance/portraial
    ...
    androgynous: 3  # Wishes to portray no gender. Uses alternate pronouns:
                    # zhe/zher(s)
    # Can have alternate gender that uses genderless pronouns as #4
    transman: 5     # Openly transgender man. Uses male pronouns, but profile
                    # shows transman
    transwoman: 6   # Openly transgender woman. Uses female pronouns, but
                    # profile shows transwoman
